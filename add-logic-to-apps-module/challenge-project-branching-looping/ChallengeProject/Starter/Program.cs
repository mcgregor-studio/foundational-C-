    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                // Checking pet physical description
        ...
        case "4":
             ...
             for (int i = 0; i < maxPets; i++)
            {
                ...
                // Checking pet personality description
            ...
            Console.WriteLine("Nickname and personality descriptions are complete for all of our friends.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
